...
async def start_vincenzo():
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await ydk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await ydk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await ydk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
            await ydk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await wdk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await wdk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await wdk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await hdk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await sdk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await adk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await bdk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await cdk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await ddk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await edk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await vkk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
            await kkk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await lkk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await mkk(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await sid(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
            await shy(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await aan(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await ake(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await eel(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await khu(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
            await shi(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
            await yaa(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
            await dav(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@vincenzo_spam_bot_support"))
            await raj(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@our_SECRET_SOCIETY"))
            await put(functions.channels.JoinChannelRequest(channel="@hamaari_paltan"))
            await put(functions.channels.JoinChannelRequest(channel="@vincenzo_support_chat"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("KNOCK KNOCK TERA BAAP AYA............")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("KNOCK KNOCK TERA BAAP AAYA.........")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("...........SUCESSFULLY LEFT KIDS CHAT..........")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        smex = await e.get_reply_message()
        VINCENZO = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        vincen = VINCENZO[1:]
        if len(vincen) == 2:
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 11:
            ...
            appendable = [g]
            qeue.append(appendable)
            text = "FUCKING SUCCESSFULLY STARTED........."
            await e.reply(text, parse_mode=None, link_preview=None )
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
