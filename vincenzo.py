...
async def start_rizoel():
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await ydk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await ydk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await ydk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await wdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await hdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await hdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await hdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await sdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await adk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await bdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await cdk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await ddk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await edk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await edk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await edk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await vkk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await kkk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await lkk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await lkk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await lkk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await mkk(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await sid(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await shy(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await aan(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await ake(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await eel(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await khu(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await khu(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await shi(functions.channels.JoinChannelRequest(channel="@hamaari_paltan"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await yaa(functions.channels.JoinChannelRequest(channel="@hamaari_paltan"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await dav(functions.channels.JoinChannelRequest(channel="@hamaari_Paltan"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await raj(functions.channels.JoinChannelRequest(channel="@hamaari_paltan"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
            await put(functions.channels.JoinChannelRequest(channel="@koii_nhi_apnaa"))
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 5:
            ...
            try:
                ...
                await event.edit("Succesfully Changed Bio By vincenzo spam bot..")
            except Exception as e:
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        vincenzo = ("".leave(e.text.split(maxsplit=1)[1:])).split(" ", 1)
        if len(e.text) == 7:
            bc = vincenzo[0]
            bc = int(bc)
            text = " Leaving....."
...
async def alive(e):
    if e.sender_id in SMEX_USERS:
        text = " ¸„.-•~¹°”ˆ˜¨  𝖛𝖎𝖓𝖈𝖊𝖓𝖟𝖔 𝖒𝖚𝖑𝖙𝖎 𝖘𝖕𝖆𝖒 𝖇𝖔𝖙¨˜ˆ”°¹~•-.„¸\n\n\n 𝔰𝔭𝔞𝔪 𝔟𝔬𝔱 𝔦𝔰 𝔞𝔩𝔦𝔳𝔢!!\n\n ┏━━━━━━━━━━━━━━━━━━━\n ┣➣ ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ : 4.1.2\n ┣➣ ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ : 1.9 \n ┣➣ sᴜᴘᴘᴏʀᴛ : @koii_nhi_apnaa\n ┣➣ ᴄʀᴇᴀᴛᴇʀ :  ۷ıŋƈɛŋʑơ\n ┗━━━━━━━━━━━━━━━━━━━\n "
        await e.reply(text, parse_mode=None, link_preview=None )
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = "𝐀𝐕𝐀𝐈𝐋𝐀𝐁𝐋𝐄 𝐂𝐎𝐌𝐌𝐌𝐀𝐍𝐃𝐒 𝐈𝐍 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓 \n\n𝐔𝐓𝐈𝐋𝐒 𝐂𝐎𝐌𝐌𝐀𝐍𝐃:\n.alive\n.ping\n.restart\n\n𝐔𝐒𝐄𝐑𝐁𝐎𝐓 𝐂𝐎𝐌𝐌𝐀𝐍𝐃:\n.bio\n.join\n.leave\n.pjoin\n.pleave\n\n𝐒𝐏𝐀𝐌 𝐂𝐎𝐌𝐌𝐀𝐍𝐃:\n.spam\n.delayspam\n.bigspam\n.raid\n.replyraid\n.dreplyraid\n\n\nFor more help regarding usage of plugins type plugins name"
       await e.reply(text, parse_mode=None, link_preview=None )
...
text = """                                 
 _   __(_)___  ________  ____  ____  ____ 
| | / / / __ \/ ___/ _ \/ __ \/_  / / __ \
| |/ / / / / / /__/  __/ / / / / /_/ /_/ /
